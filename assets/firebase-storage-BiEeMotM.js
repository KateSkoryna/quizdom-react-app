import{_ as Pe,C as Ie,r as se,S as ve,a as xe,F as De,g as Le,h as j,c as Be,d as Fe,i as ce,p as Me,u as qe,f as He}from"./firebase-auth-CdGnQTp9.js";/**
 * @license
 ...
 */const he="firebasestorage.googleapis.com",de="storageBucket",ze=2*60*1e3,$e=10*60*1e3,je=1e3;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ne="storage";function en(t,e,n){return t=j(t),$t(t,e,n)}function tn(t){return t=j(t),jt(t)}function nn(t,e){return t=j(t),Wt(t,e)}function sn(t=Le(),e){t=j(t);const s=Be(t,Ne).getImmediate({identifier:e}),r=Fe("storage");return r&&Zt(s,...r),s}function Zt(t,e,n,s={}){Kt(t,e,n,s)}function Yt(t,{instanceIdentifier:e}){const n=t.getProvider("app").getImmediate(),s=t.getProvider("auth-internal"),r=t.getProvider("app-check-internal");return new ne(n,s,r,e,ve)}function Jt(){Pe(new Ie(Ne,Yt,"PUBLIC").setMultipleInstances(!0)),se(ue,le,""),se(ue,le,"esm2020")}Jt();export{tn as a,Zt as c,sn as g,nn as r,en as u};
