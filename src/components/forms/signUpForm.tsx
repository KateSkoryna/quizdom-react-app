    ...
    <Form onSubmit={handleSubmit(onSubmit)}>
          ...
          <Form.Group className="mb-2" controlId="dateOfBirth">
            ...
            <Controller
              ...
              render={({ field: { onChange, value } }) => (
                <DatepickerContainer value={value} callback={onChange} />
              )}
            />
            {errors.dateOfBirth
              ? addClassnameToText("text-danger", errors.dateOfBirth.message)
              : addClassnameToText(styles.errorText)}
          </Form.Group>
        </Col>
        <Col xs={12} sm={12} md={6} lg={6}>
      ...
      <Form.Group className="mb-2" controlId="confirmBasicPassword">
        ...
        {errors.confirmPassword
          ? addClassnameToText("text-danger", errors.confirmPassword.message)
          : addClassnameToText(styles.errorText)}
      </Form.Group>
